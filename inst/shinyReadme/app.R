...
if(!require("semantic.dashboard")) devtools::install_github('Appsilon/semantic.dashboard', dependencies = TRUE)
if(!require("shiny.semantic")) install.packages('shiny.semantic', dependencies = TRUE)
